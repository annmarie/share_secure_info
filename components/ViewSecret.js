...
export default function ViewSecret(props) {
  ...
  const validComponent = (
    <Container size="sm">
      ...
      <Typography variant="h4" color="textPrimary" style={{ marginBottom: "10px" }}>
      ...
      <Button type="submit" color="primary" variant="contained" onClick={handleButtonClick}>
  ...
  const invalidComponent = (
    <Container size="sm" style={{ textAlign: "center" }}>
      <Typography variant="h4" color="textPrimary" style={{ marginBottom: "20px" }}>
